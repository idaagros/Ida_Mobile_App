...
class ImageHelper {
  ...
  /// Returns compressed bytes + filename, or null if cancelled / rejected.
  static Future<({Uint8List bytes, String name})?> pickWithSheet(
    ...
    return (bytes: bytes, name: normalizedName);
  }
