...
class _OtpApprovalsScreenState extends State<OtpApprovalsScreen> {
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        title: Row(children: [
          ...
          Text('Approved for $username',
              style:
                  const TextStyle(fontSize: 15, fontWeight: FontWeight.w700)),
        ]),
        content: Column(mainAxisSize: MainAxisSize.min, children: [
          const Text(
              'Share this OTP with the user (via WhatsApp or call). It expires in 15 minutes.',
        ...
        actions: [
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: const Text('Done — I\'ve shared the OTP',
                  style: TextStyle(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text('OTP Approvals',
                  ...
                  _requests.isEmpty
                      ? ListView(children: [
                          ...
                          Center(
                            ...
                            const SizedBox(height: 14),
                            const Text('No pending OTP requests',
                                style: TextStyle(
                                    fontSize: 15, color: Colors.black54)),
                            const SizedBox(height: 6),
                            Text(
                                'Users requesting password access will appear here',
                                style: TextStyle(
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          Expanded(
            child:
              ...
              Text(req['username']?.toString() ?? 'Unknown',
                  style: const TextStyle(
                      fontSize: 14, fontWeight: FontWeight.w700)),
              Text('Requesting Password Manager access',
                  style:
        ...
        Row(children: [
          ...
          Text(_timeAgo(req['created_at']?.toString()),
        ...
        if (alreadyApproved) ...[
          ...
          Container(
            ...
            decoration: BoxDecoration(
                color: const Color(0xFFF4F7F2),
                borderRadius: BorderRadius.circular(10),
                border: Border.all(color: idaGreen)),
            child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              GestureDetector(
                onTap: () => Clipboard.setData(
                    ClipboardData(text: _approvedOtps[req['id']]!)),
                child:
                    const Icon(Icons.copy, size: 16, color: Color(0xFF1A73E8)),
              ),
            ]),
          ),
        ] else ...[
            ...
            Expanded(
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                    ...
                    shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(8))),
                child: const Text('Approve & Show OTP',
                    style: TextStyle(
                        color: Colors.white, fontWeight: FontWeight.w700)),
              ),
            ),
  ...
  Widget _processedCard(Map req) {
    ...
    final color =
        isApproved ? const Color(0xFF3B7A28) : const Color(0xFFB23A3A);
