// lib/screens/admin/parties_screen.dart
//
// Admin-managed master list of parties — used as the dropdown when
// creating an outward register dispatch entry. Simple add/rename/
// activate-deactivate, same shape as destinations_screen.dart.
...
class _PartiesScreenState extends State<PartiesScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final res = await http.get(Uri.parse('$baseUrl/parties?all=1'), headers: h);
  ...
  void _showAddDialog() {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: const Text('Add Party', style: TextStyle(fontWeight: FontWeight.w700)),
        content: TextField(
          controller: ctrl,
          autofocus: true,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text('Manage Parties', style: TextStyle(fontSize: 17, fontWeight: FontWeight.w600)),
      ),
      ...
      body: loading
          ...
          : parties.isEmpty
              ? const Center(child: Text('No parties yet — tap + to add one', style: TextStyle(color: Colors.black54)))
              : ListView.separated(
