...
class MachineMaintScreen extends StatefulWidget {
  ...
  // land there directly rather than always opening on Activities.
  final int? initialTabIndex;
  const MachineMaintScreen({super.key, this.initialTabIndex});
  @override
  State<MachineMaintScreen> createState() => _MachineMaintScreenState();
}

class _MachineMaintScreenState extends State<MachineMaintScreen>
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Padding(
            ...
            child:
              ...
              // Rate-based projection - only shown when there's enough
              // recent usage history to compute a meaningful rate.
              // Silently omitted otherwise rather than showing a
              // confusing placeholder for a brand-new machine.
