...
//
// Admin-only: capture a worker's face once so Face Recognition can
// recognize them later during attendance marking. Opens the camera,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text('Enroll Face — ${widget.workerName}',
