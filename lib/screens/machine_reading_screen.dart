...
class MachineReadingScreen extends StatefulWidget {
  ...
  @override
  State<MachineReadingScreen> createState() => _MachineReadingScreenState();
}

class _MachineReadingScreenState extends State<MachineReadingScreen> {
  ...
  // photo_url from the DB is a relative path like '/uploads/machine/x.jpg'
  ...
  // All validation and hours-run calculations are based on this
  ...
  Future<void> _submit() async {
    ...
    if (readingCtrl.text.isEmpty) {
      setState(() => errorMessage = 'Please enter the machine meter reading');
      return;
    }
    ...
    try {
      ...
      if (res.statusCode == 200 || res.statusCode == 201) {
        final newMonthly =
            double.tryParse(data['monthly_hours']?.toString() ?? '0') ?? 0;
        final newOverall =
            double.tryParse(data['overall_hours']?.toString() ?? '0') ?? 0;
        final newHours =
            double.tryParse(data['hours_run']?.toString() ?? '0') ?? 0;
                ...
                builder: (_) => AlertDialog(
                  ...
                  content: Column(
                      ...
                      children: [
                        ...
                        ...newAlerts.map<Widget>((a) => Padding(
                  ...
                  actions: [
                    ...
                    ElevatedButton(
                      ...
                      child: const Text('View Maintenance',
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(children: [
          ...
          const Flexible(
              child: Text('Machine Hours Reading',
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    // Meter reading
                    _sectionLabel('MACHINE METER READING (hrs)'),
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon: const Icon(Icons.factory, color: idaGreen),
                    ...
                    TextField(
                      ...
                      maxLines: 3,
                      decoration: InputDecoration(
                        hintText: 'Any observations about the machine...',
                        hintStyle: TextStyle(
