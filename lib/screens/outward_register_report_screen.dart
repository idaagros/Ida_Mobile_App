...
class OutwardRegisterReportScreen extends StatefulWidget {
  ...
  @override
  State<OutwardRegisterReportScreen> createState() => _OutwardRegisterReportScreenState();
}

class _OutwardRegisterReportScreenState extends State<OutwardRegisterReportScreen> {
  ...
  Future<void> _pickDate({required bool isFrom}) async {
    final picked = await showDatePicker(
      ...
      builder: (ctx, child) => Theme(
        data: Theme.of(ctx).copyWith(colorScheme: const ColorScheme.light(primary: idaGreen)),
        child: child!,
      ),
    );
  ...
  Future<void> _generate(String format) async {
    ...
    try {
      ...
      if (res.statusCode == 200) {
        ...
        setState(() => errorMessage = data['error'] ?? 'Failed to generate report');
      }
    } catch (e) {
      ...
      builder: (_) => SafeArea(
        child: Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text(filename, style: const TextStyle(fontSize: 12, color: Color(0xFF6B7280))),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text('Outward Register Report', style: TextStyle(fontSize: 17, fontWeight: FontWeight.w600)),
      ),
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(children: [
                Expanded(child: _dateTile('From', fromDate, () => _pickDate(isFrom: true))),
                const SizedBox(width: 10),
                Expanded(child: _dateTile('To', toDate, () => _pickDate(isFrom: false))),
              ]),
              const SizedBox(height: 16),
          ...
          if (errorMessage != null) ...[
            ...
            Container(
              ...
              child: Row(children: [
                ...
                Expanded(child: Text(errorMessage!, style: TextStyle(fontSize: 12, color: Colors.red.shade700))),
              ]),
            ),
          ],
            ...
            Expanded(
              child: SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: const Text('Excel (.xlsx)', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700)),
                  style: ElevatedButton.styleFrom(backgroundColor: idaGreen, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12))),
                ),
              ),
            ),
            const SizedBox(width: 10),
