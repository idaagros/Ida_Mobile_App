...
class ElectricityBillProjectionScreen extends StatefulWidget {
  ...
  @override
  State<ElectricityBillProjectionScreen> createState() =>
      _ElectricityBillProjectionScreenState();
}

class _ElectricityBillProjectionScreenState
  ...
  Widget _totalCard(Map d) {
    return Container(
      ...
      child: Column(children: [
        Text('PROJECTED BILL — ${d['days_in_month']} DAY MONTH',
            style: TextStyle(
                fontSize: 11,
        ...
        Text(_rupees(d['projected_total']),
            style: const TextStyle(
                fontSize: 34,
                fontWeight: FontWeight.w700,
                color: Colors.white)),
      ...
      child: Row(children: [
        ...
        Expanded(
          child:
            ...
            Text(
                'Poor power factor is costing you approximately ${_rupees(cost)} this month',
                style: const TextStyle(
                    fontSize: 13.5,
                    fontWeight: FontWeight.w700,
            ...
            if (pf != null)
              Padding(
                ...
                child: Text(
                    'At average PF ${(pf as num).toStringAsFixed(3)}, versus the ideal of 1.0',
                    style: const TextStyle(
  ...
  Widget _basisCard(Map d) {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        if (d['demand_charge_note'] != null) ...[
          const SizedBox(height: 4),
          Text(d['demand_charge_note'],
              style: TextStyle(fontSize: 11.5, color: Colors.grey.shade600)),
        ],
      ]),
    );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        foregroundColor: Colors.white,
        elevation: 0,
        title: const Text('Tariff Settings',
            style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
      ),
      body: loading
          ? const Center(child: CircularProgressIndicator(color: idaGreen))
          : Responsive.constrainedContent(
              ...
              ListView(
                ...
                children: [
                  ...
                  _rateField('Wheeling charge rate', wheelingCtrl,
                      suffix: '₹/unit'),
                  _rateField('FAC rate', facCtrl, suffix: '₹/unit'),
                  _rateField('Demand charge rate', demandRateCtrl,
                      suffix: '₹/KVA'),
                  ...
                  Container(
                    ...
                    child: Column(children: [
                      RadioListTile<String>(
                        ...
                        title: const Text(
                            'kWh (needs PF conversion to bill on kVAh)',
                      ...
                      RadioListTile<String>(
                        ...
                        onChanged: (v) => setState(() => readingType = v!),
                        title: const Text(
                            'kVAh (already the billed unit, no conversion)',
                            style: TextStyle(fontSize: 13)),
                        activeColor: idaGreen,
                        dense: true,
                      ),
